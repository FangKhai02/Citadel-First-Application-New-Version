        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: expanded ? _cyan : _borderGlass,
              ...
              children: [
                ...
                AnimatedRotation(
                  ...
                  child: Icon(
                    ...
                    color: expanded ? _cyan : _textMuted,
                    size: 22,
                  ),
                ),
              ],
            ...
            children: DocumentType.values.map((type) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? _cyan.withAlpha(12) : Colors.transparent,
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(
                          _getIcon(type),
                          color: isSelected ? _cyan : _textMuted,
                          size: 18,
                        ),
                      ),
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.jost(
                                ...
                                color: isSelected ? _textHeading : _textBody,
                              ),
                            ),
                            Text(
                              type.description,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: image != null ? _cyan.withAlpha(90) : _borderGlass,
