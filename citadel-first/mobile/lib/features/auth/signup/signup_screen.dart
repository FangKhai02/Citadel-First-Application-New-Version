            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    CitadelColors.primary.withAlpha(28),
                    CitadelColors.primaryDark.withAlpha(10),
                    Colors.transparent,
                  ],
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    CitadelColors.primary.withAlpha(38),
                    Colors.transparent,
                  ],
                ),
              ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    CitadelColors.primaryDark.withAlpha(18),
                    Colors.transparent,
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? CitadelColors.primary.withAlpha(12) : Colors.white.withAlpha(6),
          borderRadius: BorderRadius.circular(22),
          border: Border.all(
            color: selected ? CitadelColors.primary.withAlpha(120) : CitadelColors.border.withAlpha(45),
            width: selected ? 1.5 : 1,
          ),
          boxShadow: selected
              ? [
                  BoxShadow(
                    color: CitadelColors.primary.withAlpha(35),
                    blurRadius: 24,
        ...
        child: Row(
          children: [
            AnimatedContainer(
              ...
              height: 58,
              decoration: BoxDecoration(
                color: selected ? CitadelColors.primary.withAlpha(18) : Colors.white.withAlpha(6),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: selected ? CitadelColors.primary.withAlpha(80) : CitadelColors.border.withAlpha(45),
                  width: 1,
                ),
              ),
              child: Icon(
                icon,
                color: selected ? CitadelColors.primary : CitadelColors.textMuted,
                size: 26,
              ),
            ),
                ...
                children: [
                  Text(
                    ...
                    style: GoogleFonts.jost(
                      ...
                      color: selected ? CitadelColors.textPrimary : _textSub,
                      letterSpacing: -0.1,
                    ),
                  ),
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: selected ? CitadelColors.primary : Colors.transparent,
                border: Border.all(
                ...
                boxShadow: selected
                    ? [
                        BoxShadow(
                          color: CitadelColors.primary.withAlpha(90),
                          blurRadius: 12,
                          spreadRadius: 1,
                        )
                      ]
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: selected
                    ? [
                        BoxShadow(
                          color: CitadelColors.primary.withAlpha(80),
                          blurRadius: 8,
                        )
                      ]
                    : [],
