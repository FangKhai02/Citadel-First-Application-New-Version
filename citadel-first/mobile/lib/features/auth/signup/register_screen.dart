                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: GoogleFonts.bodoniModa(
                                  ...
                                  color: CitadelColors.textPrimary, letterSpacing: -0.3,
                                  height: 1.15,
                                ),
                              ),
                              ...
                              Text(
                                ...
                                style: GoogleFonts.jost(
                                  ...
                                  color: CitadelColors.textMuted, height: 1.6,
                                ),
                              ),
                              ...
                              _InputField(
                                ...
                                suffixIcon: IconButton(
                                  icon: Icon(
                                    ...
                                    color: CitadelColors.textMuted, size: 20,
                                  ),
    ...
    return Row(
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: met ? CitadelColors.primary.withAlpha(20) : Colors.transparent,
            border: Border.all(
              color: met ? CitadelColors.primary : CitadelColors.textMuted.withAlpha(60),
              width: 1.5,
            ),
          ),
          child: met
              ? const Icon(Icons.check_rounded, size: 12, color: CitadelColors.primary)
              : null,
        ),
        ...
        Text(
          ...
          style: GoogleFonts.jost(
            ...
            color: met ? _textSub : CitadelColors.textMuted,
            height: 1.4,
          ),
        ),
      ],
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(message,
                style: GoogleFonts.jost(fontSize: 13, fontWeight: FontWeight.w300, color: CitadelColors.error, height: 1.5)),
          ),
        ],
      ),
    );
