        ...
        return Theme(
          data: ThemeData.dark().copyWith(
            colorScheme: const ColorScheme.dark(
              ...
              onSurface: CitadelColors.textBody,
            ),
          ),
          child: child!,
        );
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.badge_outlined, size: 20, color: CitadelColors.primary),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          const Icon(Icons.flight_outlined, size: 20, color: CitadelColors.primary),
                                          const SizedBox(width: 10),
                                          Text(
                                            'Passport Details',
                                            style: GoogleFonts.jost(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: expiryDate != null
                ? CitadelColors.primary.withAlpha(180)
        ...
        child: Row(
          children: [
            Icon(Icons.calendar_today_outlined, size: 18, color: CitadelColors.textMuted),
            ...
            Icon(Icons.expand_more_rounded, color: CitadelColors.textMuted, size: 20),
          ],
        ),
      ),
    );
