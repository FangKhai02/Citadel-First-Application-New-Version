                                    ...
                                    if (_isSourceOfFundOther) ...[
                                      ...
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIcon: Icon(Icons.edit_outlined, size: 18, color: CitadelColors.textMuted),
...
class _DropdownField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField<String>(
      ...
      icon: const Icon(Icons.expand_more_rounded, color: CitadelColors.textMuted, size: 20),
      decoration: InputDecoration(
  ...
  Widget _toggleChip({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? CitadelColors.primary.withAlpha(30) : Colors.white.withAlpha(6),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: selected ? CitadelColors.primary : CitadelColors.border,
            width: 1,
          ),
        ),
        child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: CitadelColors.border.withAlpha(80), width: 1),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: CitadelColors.error.withAlpha(60), width: 1),
                    ),
                    child: const Icon(
                      Icons.close_rounded,
                      size: 16,
          ...
          if (row.jurisdiction == 'Others') ...[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.edit_location_outlined, size: 18, color: CitadelColors.textMuted),
                hintStyle: GoogleFonts.jost(
                    fontSize: 13, fontWeight: FontWeight.w300, color: const Color(0xFF475569)),
                filled: true,
                fillColor: CitadelColors.surface,
          ...
          if (widget.showErrors && row.tinStatus == null)
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.jost(fontSize: 12, color: CitadelColors.error),
              ),
            ),
          ...
          if (row.tinStatus == 'have_tin') ...[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText: 'Enter TIN',
                prefixIcon: Icon(Icons.pin_outlined, size: 18, color: CitadelColors.textMuted),
                hintStyle: GoogleFonts.jost(
                ...
                enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide:
                      const BorderSide(color: CitadelColors.border, width: 1),
                ),
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide:
                      BorderSide(color: CitadelColors.primary.withAlpha(180), width: 1.5),
                ),
                errorBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide: const BorderSide(color: CitadelColors.error, width: 1),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: selected ? CitadelColors.primary : (hasError ? CitadelColors.error : CitadelColors.border),
            width: 1,
          ),
        ),
        child: Center(
        ...
        child: Row(
          ...
          children: [
            const Icon(Icons.add_circle_outline_rounded,
                size: 18, color: CitadelColors.primary),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: InputDecorator(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.flag_outlined, size: 18, color: CitadelColors.textMuted),
          suffixIcon: Icon(Icons.expand_more_rounded, color: CitadelColors.textMuted, size: 20),
          filled: true,
          fillColor: CitadelColors.surface,
          contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
          enabledBorder: OutlineInputBorder(
            ...
            borderSide: BorderSide(
                color: errorText != null ? CitadelColors.error : CitadelColors.border, width: 1),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(
                color: errorText != null ? CitadelColors.error : CitadelColors.primary.withAlpha(180), width: 1.5),
          ),
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: CitadelColors.error, width: 1),
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon:
                        Icon(Icons.search_rounded, size: 20, color: CitadelColors.textMuted),
                    filled: true,
                    fillColor: CitadelColors.surface,
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                      borderSide: BorderSide(
                          color: CitadelColors.primary.withAlpha(180), width: 1.5),
                    ),
                  ),
                ),
              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: isSelected
                                      ...
                                      : CitadelColors.border.withAlpha(60),
                                  width: 1,
                                ),
                              ),
                              child: Row(
                                children: [
                                  if (isSelected) ...[
                                    const Icon(Icons.check_rounded,
                                        size: 16, color: CitadelColors.primary),
                                    const SizedBox(width: 8),
                                  ],
                                  Expanded(
                                    child: Text(
