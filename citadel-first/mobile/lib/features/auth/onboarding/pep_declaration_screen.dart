    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: selected
              ? [BoxShadow(color: CitadelColors.primary.withAlpha(35), blurRadius: 16, offset: const Offset(0, 4))]
              : [],
        ),
        child: Center(
          child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isUploaded
              ? CitadelColors.primary.withAlpha(12)
              : Colors.white.withAlpha(8),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isUploaded
                ? CitadelColors.primary.withAlpha(80)
            ...
            : Row(
                ...
                children: [
                  Icon(
                    ...
                    size: 18,
                    color: isUploaded ? CitadelColors.primary : CitadelColors.primary,
                  ),
                  ...
                  Flexible(
                    child: Text(
                      ...
                      style: GoogleFonts.jost(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                        color: isUploaded ? CitadelColors.primary : CitadelColors.textBody,
                        letterSpacing: 0.3,
                      ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: CitadelColors.error.withAlpha(60),
                            width: 1,
                          ),
                        ),
                        child: const Icon(
