                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _DisclaimerCard(
                              ...
                              accentColor: CitadelColors.primary,
                              title: 'Data & Privacy',
                              body:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(height: 1, color: CitadelColors.border.withAlpha(80)),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: CitadelColors.primary.withAlpha(38), width: 1),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
            ...
            child: Icon(Icons.info_outline_rounded, color: CitadelColors.primary, size: 17),
          ),
