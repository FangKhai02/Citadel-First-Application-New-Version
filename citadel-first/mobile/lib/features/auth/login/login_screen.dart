      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Switch', style: ibm(color: CitadelColors.primary, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Sign in to your account',
                                style: ibm(fontSize: 13, color: CitadelColors.textMuted)),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(
                color: CitadelColors.primary.withAlpha(30),
                blurRadius: 50,
                spreadRadius: 12,
              ),
            ],
