    ...
    return showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: _borderGlass, width: 1),
        ),
        title: Row(
          children: [
            Icon(Icons.warning_amber_rounded, color: _cyan, size: 24),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.home_outlined, size: 20, color: _cyan),
                                        const SizedBox(width: 10),
                                        Text(
                                          'Residential Address',
                                          style: GoogleFonts.jost(
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: Checkbox(
                                              ...
                                              side: const BorderSide(color: _borderGlass, width: 1.5),
                                              shape: RoundedRectangleBorder(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.contact_phone_outlined, size: 20, color: _cyan),
                                        const SizedBox(width: 10),
                                        Text(
                                          'Contact Details',
                                          style: GoogleFonts.jost(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(
          prefixIcon,
          size: 18,
          color: enabled ? _textMuted : _textMuted.withAlpha(80),
        ),
        hintStyle: GoogleFonts.jost(
          fontSize: 13,
          fontWeight: FontWeight.w300,
          color: _textMuted.withAlpha(80),
        ),
        ...
        disabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _borderGlass.withAlpha(60), width: 1),
        ),
